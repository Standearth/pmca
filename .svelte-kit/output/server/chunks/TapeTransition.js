...
function Meta($$renderer, $$props) {
  ...
  head($$renderer, ($$renderer2) => {
    ...
    $$renderer2.push(`<meta name="description"${attr("content", description)}/> <meta name="author" content="Prime Members for Cleaner Amazon"/> <meta name="news_keywords"${attr("content", keywords)}/> <meta property="og:title"${attr("content", title)}/> <meta property="og:site_name" content="Prime Members for Cleaner Amazon"/> <meta property="og:url"${attr("content", url)}/> <meta property="og:description"${attr("content", description)}/> <meta property="og:type" content="article"/> <meta property="og:locale" content="en_US"/> <meta property="og:image"${attr("content", `${stringify(url)}${stringify(base)}/hero-bg.webp`)}/> <meta property="og:image:type" content="image/webp"/> <meta property="og:image:width" content="1200"/> <meta property="og:image:height" content="628"/> <meta name="twitter:card" content="summary_large_image"/> <meta name="twitter:site" content=""/> <meta name="twitter:creator" content=""/> <meta name="twitter:title"${attr("content", title)}/> <meta name="twitter:description"${attr("content", description)}/> <meta name="twitter:image:src"${attr("content", `${stringify(url)}${stringify(base)}/hero-bg.webp`)}/> <meta name="robots" content="max-image-preview:large"/> <link rel="canonical"${attr("href", `${stringify(url)}/`)}/> <link rel="icon" type="image/svg+xml"${attr("href", `${stringify(base)}/marker.svg`)}/> <link rel="icon" type="image/x-icon"${attr("href", `${stringify(base)}/favicon.ico`)}/> <!--[-->`);
