...
function Index($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    Footer($$renderer2);
    $$renderer2.push(`<!----> <div${attr_class("popup-overlay svelte-tfcqlg", void 0, { "show": showPopup })}><div class="popup-content svelte-tfcqlg"><button class="popup-close svelte-tfcqlg">×</button> <iframe${attr("src", `https://act.stand.earth/page/88799/petition/1${stringify(typeof window !== "undefined" ? window.location.search : "")}`)} title="Join the campaign" class="popup-iframe svelte-tfcqlg" loading="eager"></iframe></div></div>`);
  });
}
...
function version() {
  ...
  console.log(`build: ${"2025-10-06-20:30"}`);
  console.log("--- --- --- --- --- ---");
}
