...
function RollCall($$renderer, $$props) {
...
function version() {
  ...
  console.log(`build: ${"2025-10-07-21:22"}`);
  console.log("--- --- --- --- --- ---");
}
