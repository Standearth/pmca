<script>
	...
	let iframeSrc = $state("https://act.stand.earth/page/88799/petition/1?supporter.country=Canada");
	...
	onMount(() => {
		...
		// Update iframe src with URL parameters, preserving supporter.country=Canada
		const params = new URLSearchParams(window.location.search);
		params.set('supporter.country', 'Canada');
		iframeSrc = `https://act.stand.earth/page/88799/petition/1?${params.toString()}`;
