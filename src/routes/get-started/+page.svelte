<script>
	...
	import { trackGetStartedRefConversion, trackSocialButtonClick } from '$utils/analytics.js';
	...
	function handleSocialClick(platform) {
		// Track the social button click
		trackSocialButtonClick(platform, hasRef, refId);
	}
	...
	onMount(() => {
		...
		// Only run generateUniqueUrl if ref parameter is present, not empty, not null, and not undefined
		if (refParam && refParam !== '' && refParam !== null && refParam !== undefined && refParam !== 'undefined') {
			refId = refParam;
			hasRef = true;
			...
			// Track this as a key conversion - get-started page visited with ref parameter
			trackGetStartedRefConversion(refParam);
		} else {
...
<section class="social-sharing">
	<div class="container">
		...
		<div class="social-buttons">
			<a href={getShareUrl('facebook')} target="_blank" class="social-btn facebook" onclick={() => handleSocialClick('facebook')}>
			...
			<a href={getShareUrl('bluesky')} target="_blank" class="social-btn bluesky" onclick={() => handleSocialClick('bluesky')}>
				<span class="social-icon">
					<img src="{base}/Bluesky_Logo_White.svg" alt="Bluesky" />
				</span>
				<span>Bluesky</span>
			</a>
			<a href={getShareUrl('email')} class="social-btn email" onclick={() => handleSocialClick('email')}>
				<span class="social-icon">
					<svg viewBox="0 0 24 24" fill="currentColor">
			...
			<a href={getShareUrl('whatsapp')} target="_blank" class="social-btn whatsapp" onclick={() => handleSocialClick('whatsapp')}>
				<span class="social-icon">
					<svg viewBox="0 0 24 24" fill="currentColor">
			...
			<a href={getShareUrl('linkedin')} target="_blank" class="social-btn linkedin" onclick={() => handleSocialClick('linkedin')}>
				<span class="social-icon">
					<svg viewBox="0 0 24 24" fill="currentColor">
