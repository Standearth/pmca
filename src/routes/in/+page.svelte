<script>
	...
	function openEmailPopup() {
		trackCampaignAction('join_email_popup_open', { country: 'India', page: 'in' });
		showPopup = true;
	...
	function trackWhatsApp() {
		...
		trackCampaignAction('join_whatsapp_click', { country: 'India', page: 'in' });
		trackMetaPixelWhatsAppClick('in', 'India');
	}
...
<!-- Popup Modal with India country pre-population -->
<PopupModal bind:show={showPopup} baseUrl={indiaIframeBaseUrl} />

<!-- Hero Section with India Background Image -->
<section class="hero">
	<div class="hero-background">
		<img 
			src="{base}/hero-india.webp"
			alt="Hero background"
			class="hero-image"
		/>
	</div>
	...
	<div class="hero-content">
		<div class="hero-text">
			<h1>Join Prime members across India demanding cleaner Amazon.</h1>
